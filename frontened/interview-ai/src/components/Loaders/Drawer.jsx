...
export const Drawer = ({ isOpen, onClose, title, children }) => {
  return (
    <div
      className={`fixed top-[64px] right-0 z-40 h-[calc(100dvh-64px)] p-4 overflow-y-auto transition-transform bg-white shadow-2xl shadow-cyan-800/10 border-l border-gray-200 w-full md:w-[400px] ${
